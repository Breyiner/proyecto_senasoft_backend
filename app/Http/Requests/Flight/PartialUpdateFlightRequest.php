...
class PartialUpdateFlightRequest extends FormRequest
{
  ...
  public function rules(): array
  {
    return [
      ...
      'origin_city_id' => 'sometimes|exists:cities,id',
      'destination_city_id' => 'sometimes|exists:cities,id|different:origin_city_id',
